...
const V2 = {
  firmware_download: {
    list: "/api/monitor/v2/firmware-download",
    supportsResult: true,
  },
  mac_write: {
    list: "/api/monitor/v2/mac-write",
    supportsResult: true,
  },
  mac_check: {
    list: "/api/monitor/v2/mac-check",
    supportsResult: true,
  },
  device_print: {
    list: "/api/monitor/v2/device-print",
    supportsResult: false,
  },
  giftbox_print: {
    list: "/api/monitor/v2/giftbox-print",
    supportsResult: false,
  },
  cartonbox_print: {
    list: "/api/monitor/v2/cartonbox-print",
    supportsResult: false,
  },
};
...
export default function MonitorDetailUnified() {
  injectOnce();
    ...
    try {
      ...
      while (true) {
        ...
        if (!ct.includes("application/json")) {
          const text = await res.text();
          console.error(
            "[MonitorDetailUnified][CSV] Non-JSON:",
            res.status,
            ct,
            text.slice(0, 200),
          );
      ...
      const filename = `monitor_${activeTab}${resultSuffix}_${safeFrom}_${safeTo}.csv`;
